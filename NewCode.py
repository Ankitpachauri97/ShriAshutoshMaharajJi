...
def on_ticks(ws, ticks):
    ...
    if unrealised_first_position < unrealised_second_position and unrealised_second_position > 0:
        ...
        Closest_instrument_value_TradingSymbol = END[0:10] + str(int(
            InstrumentTokenList_TradingSymbolList_dict[instrument_second_position][-7:-2])-int(50)) + END[-2:]
        Closest_instrument_value = TradingSymbolList_InstrumentTokenList_dict[
            Closest_instrument_value_TradingSymbol]
        pprint("Nearing call Down" + ' ' + get_key(Closest_instrument_value) + ' ' +
               str(round(InstrumentToken_LTPList[instrument_first_position]-InstrumentToken_LTPList[Closest_instrument_value], 2)) + ' ' + str(round(InstrumentToken_LTPList[Closest_instrument_value]-InstrumentToken_LTPList[instrument_second_position], 2)/2))
        if ((InstrumentToken_LTPList[instrument_first_position]-InstrumentToken_LTPList[Closest_instrument_value]) > (InstrumentToken_LTPList[Closest_instrument_value]-InstrumentToken_LTPList[instrument_second_position])/2):
    ...
    # ----------------------------Moving up the puts -------------------------------------------------------------------------------------------------------------
        ...
        Closest_instrument_value_TradingSymbol = END[0:10] + str(int(
            InstrumentTokenList_TradingSymbolList_dict[instrument_first_position][-7:-2])+int(50)) + END[-2:]
        Closest_instrument_value = TradingSymbolList_InstrumentTokenList_dict[
            Closest_instrument_value_TradingSymbol]
        pprint("nearing put up" + ' ' + get_key(Closest_instrument_value) + ' ' +
               str(round(InstrumentToken_LTPList[instrument_second_position]-InstrumentToken_LTPList[Closest_instrument_value], 2)) + ' ' + str(round(InstrumentToken_LTPList[Closest_instrument_value]-InstrumentToken_LTPList[instrument_first_position], 2)/2))
        if ((InstrumentToken_LTPList[instrument_second_position]-InstrumentToken_LTPList[Closest_instrument_value]) > (InstrumentToken_LTPList[Closest_instrument_value]-InstrumentToken_LTPList[instrument_first_position])/2):
